...
import { useRouter } from 'vue-router';
    ...
    async function submit() {
        ...
        try{
        await axios.post('identity/api/forgotPass', { email: email.value });
    ...
    async function resendOtp() {
        try {
             const resp = await axios.post('identity/api/forgotPass', { email: email.value });
    ...
    async function verifyOtp(){
        ...
        try {
            const resp = await axios.post('/identity/api/confirmOtp', {otp: otp.value })
